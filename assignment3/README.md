...
Link to GIF: http://i.imgur.com/sm2v2jt.gif

[img]http://i.imgur.com/sm2v2jt.gif[/img]

<img src='http://i.imgur.com/sm2v2jt.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
Bonus Objective #1:
Security principal not being followed: Prefer whitelisting over blacklisting
What we can do is require login for all staff pages by default, and if there is a page that doesn't require login, we can ignore the require login

OR

Security principal not being followed: Security through obscurity
We can hide the "Staff Area" from the header, so staff will need to know the URL to access the staff area, but doing this does very little to increase security as mentioned in the notes.
